...
function LoginForm() {
  return (
    <form className="flex flex-col items-center w-full">
      ...
      />
      <button className="flex flex-col items-center px-14 pt-5 pb-2.5 mt-7 mb-0 w-72 max-w-full text-base font-medium text-center text-white uppercase bg-red-700 rounded-[166px] max-md:px-5 max-md:mb-2.5">
